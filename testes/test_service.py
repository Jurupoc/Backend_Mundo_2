...
class TesteServiceMethods(unittest.TestCase):
    ...
    def test_delete_user(self):
        ...
        self.services_instance.create_new_user(user_data)
        self.assertEqual(self.services_instance.get_user_by_email(user_data)['data']['email'], user_data['email'])

        self.services_instance.delete_user(user_data)
    ...
    def test_get_user_by_id(self):
        ...
        self.assertEqual(self.services_instance.get_user_by_id(user_data)['data']['email'], user_data['email'])
    ...
    def tearDown(self):
        self.services_instance.delete_user(self.test_user)
